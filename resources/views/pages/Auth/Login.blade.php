...
@section('title', 'Login')
    ...
    <x-container>
        ...
        <div class="w-full gap-10 flex justify-center items-center">
            <div class="card bg-base-100 shadow-xl w-[50%]">
                <div class="card-body">
                  ...
                  <p class=" opacity-[0.7]">Please fill out all fields</p>
                    <form class="flex justify-center items-center flex-col gap-2">
                        ...
                        <div class="card-actions flex w-full items-center justify-end py-2 ">
              ...
              <svg width="700" height="700" >
                <image href="/undraw_login_re_4vu2.svg" width="600" height="700" />
              </svg>
        </div>
    </x-container>
    @endsection
